...
{
    static readonly MyAreaClass s_MyArea = new MyAreaClass();
    public static MyAreaClass MyArea { get { return s_MyArea; } }
    public static Feri_WebApplication.Controllers.BaseController Base = new Feri_WebApplication.Controllers.T4MVC_BaseController();
    public static Feri_WebApplication.Controllers.HomeController Home = new Feri_WebApplication.Controllers.T4MVC_HomeController();
    public static Feri_WebApplication.Controllers.PeopleController People = new Feri_WebApplication.Controllers.T4MVC_PeopleController();
    public static Feri_WebApplication.Controllers.RolesController Roles = new Feri_WebApplication.Controllers.T4MVC_RolesController();
...
{
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class MyAreaClass
    {
        public readonly string Name = "MyArea";
        public Feri_WebApplication.Areas.MyArea.Controllers.MyHomeController MyHome = new Feri_WebApplication.Areas.MyArea.Controllers.T4MVC_MyHomeController();
        public T4MVC.MyArea.HomeController Home = new T4MVC.MyArea.HomeController();
        public T4MVC.MyArea.SharedController Shared = new T4MVC.MyArea.SharedController();
    }
}
